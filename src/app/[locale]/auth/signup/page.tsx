              ...
              <form>
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="tos" className="ml-3 block text-sm">
                      I accept the
                    </label>
                    <label className="ml-1 block text-sm hover:cursor-pointer text-yellow-500" onClick={onOpen}>Terms and Conditions</label>
                  </div>
                </div>

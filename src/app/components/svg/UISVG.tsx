...
interface IconProps extends React.SVGProps<SVGSVGElement> {
  fill?: string;   // Màu sắc (có thể là string, ví dụ: "#000", "red", hoặc mã hex)
  size?: number;   // Kích thước của icon (số)
  height?: number; // Chiều cao của icon (số)
  width?: number;  // Chiều rộng của icon (số)
}
